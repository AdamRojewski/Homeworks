...
public class MainShop {
    ...
    public static CartProduct cartProduct = new CartProduct();
    ...
    private static void productManagement(String successMessage, Consumer<Product> manage){
        ...
        product.ifPresent(manage); // co to jest manage ????

        if (!product.isPresent()) {
            System.out.println("Nie ma takiego produktu, podaj prawidłowe id.");
        }else{
            System.out.println(successMessage); // co to jest success message????
        }
